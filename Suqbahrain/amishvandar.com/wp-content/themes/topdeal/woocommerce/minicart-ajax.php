...
<div class="top-form top-form-minicart topdeal-minicart pull-right">
	<div class="top-minicart-icon pull-right">
		<a class="cart-contents" href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('View your shopping cart', 'topdeal'); ?>"></a>
		<div class="cart-right">
			<h3><?php esc_html_e('My Cart','topdeal');?></h3>
			<p><?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count. esc_html__(' Item(s) ','topdeal'). '</span>';?><span class="icon-plus">-</span><?php echo $woocommerce->cart->get_cart_subtotal(); ?></p>
		</div>
	</div>
						...
						<div class="detail-item">
							<div class="product-details"> 
								...
								<div class="product-action clearfix">
									<?php echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf( '<a href="%s" class="btn-remove" title="%s"><span class="fa fa-times"></span></a>', esc_url( wc_get_cart_remove_url( $cart_item_key ) ), esc_html__( 'Remove this item', 'topdeal' ) ), $cart_item_key ); ?>           
