...
@if(Auth::user()->user_type == 'admin')
    <div class="row">
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center dash-widget bg-gray-dark dash-widget-left">
                    <div class="dash-widget-vertical">
                        <div class="rorate">{{__('PROFITS')}}</div>
                    </div>
                    <br>
                    <p class="text-normal text-main">{{__('Merchant Sells Income')}}</p>
                    <p class="text-semibold text-3x text-main">37.5 %</p>
                    <br>
                    <br>
        ...
        @php
            ...
            $company_profit = 0;
            $company_today_profit = 0;
            foreach ($merchants as $merchant){

                $result = DB::table('order_details')->where('user_id', $merchant->id)->sum('profit');
                $company_profit += $result * (37.5/100);
                $today_result = DB::table('order_details')->where('user_id', $merchant->id)
                    ->whereDate('created_at', DB::raw('CURDATE()'))->sum('profit');
                $company_today_profit += $today_result * (37.5/100);

            }
        @endphp
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center bg-gray-dark dash-widget">
                    <br>
                    <p class="text-normal text-main">{{__('Merchant Sells Total Profit')}}</p>
                    <p class="text-semibold text-3x text-main">{{--{{ number_format($company_profit ,2) }}--}}{{ $company_profit }} BHD</p>
                    <br>
                    <br>
        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center bg-gray-dark dash-widget">
                    <br>
                    <p class="text-normal text-main">{{__('Merchant Sells Today Profit')}}</p>
                    <p class="text-semibold text-3x text-main">{{ $company_today_profit }} BHD</p>
                    <br>
                    <br>
                </div>
            </div>
...
@if(Auth::user()->user_type == 'admin')
    <div class="row">
        @php
            $bdos = DB::table('users')->where('user_type', 'bdo')->count();
            $distributors = DB::table('users')->where('user_type', 'distributor')->count();
            $merchants = DB::table('users')->where('is_merchant', 1)->where('user_type', 'customer')->count();
        @endphp
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center dash-widget dash-widget-left" style="background: #294F75;">
                    <div class="dash-widget-vertical">
                        <div class="rorate">{{__('EMPLOYEE')}}</div>
                    </div>
                    <br>
                    <br>
                    <br>
                    <p class="text-normal text-2x" style="color: #fff;">{{__('Total BDO')}}</p>
                    <p class="text-semibold text-3x" style="color: #fff;">{{ $bdos }}</p>
                    <br>
                    <br>
                    <br>
                </div>
        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center dash-widget" style="background: #294F75;">
                    <br>
                    <br>
                    <br>
                    <p class="text-normal text-2x" style="color: #fff;">{{__('Total Distributor')}}</p>
                    <p class="text-semibold text-3x" style="color: #fff;">{{--{{ number_format($company_profit ,2) }}--}}{{ $distributors }}</p>
                    <br>
                    <br>
                    <br>
        ...
        <div class="col-md-4">
            <div class="panel">
                <div class="panel-body text-center dash-widget" style="background: #294F75;">
                    ...
                    <br>
                    <br>
                    <p class="text-normal text-2x" style="color: #fff;">{{__('Total Merchant')}}</p>
                    <p class="text-semibold text-3x" style="color: #fff;">{{ $merchants }} </p>
                    <br>
                    <br>
                    <br>
                </div>
