		...
		<?php if( $pfm == '' || $pfm == 'image' ){?>
			<?php if( has_post_thumbnail() ){ ?>
				<div class="entry-thumb single-thumb">
						<?php the_post_thumbnail('topdeal_blog_mobile');?>						
				</div>
			<?php }?>
		<?php } ?>
			...
			<div class="entry-meta clearfix">
				...
				<div class="entry-comment">
					<a href="<?php comments_link(); ?>">
						...
						<?php echo $post->comment_count . ( ( $post->comment_count > 1 ) ? esc_html__(' Comments ', 'topdeal') : esc_html__(' Comment ', 'topdeal') ); ?>
					</a>
				</div>
			</div>
				...
				?>
					<div <?php post_class( $class_col ); ?> >
						...
						<div class="item-relate-img">
							<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail('topdeal_related_mobile'); ?></a>
						</div>
						<?php } ?>
