                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mx-auto">
                                            <div class="row">
                                                ...
                                                @endif
                                                @if(\App\BusinessSetting::where('type', 'benefit_payment')->first()->value == 1)
                                                    <div class="col-6">
                                                        <label class="payment_option mb-4" data-toggle="tooltip" data-title="Benefit">
                                                            <input type="radio" id="" name="payment_option" value="benefit" checked>
                                                            <span>
                                                                <img loading="lazy"  src="{{ asset('frontend/images/icons/cards/benefit.png')}}" class="img-fluid">
                                                            </span>
                                                        </label>
                                                    </div>
                                                @endif
