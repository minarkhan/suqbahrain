			  ...
			  "params" => array(
				...
				array(
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array('theme_mobile','layout6'),
					 )
				),
				 array(
					"type" => "dropdown",
				 ...
				 array(
					...
					'dependency' => array(
						'element' => 'layout',
						'value' => array( 'layout4','theme_mobile2','layout6'),
					 )
				),
				  array(
					"type" => "dropdown",
				 ...
				 array(
				  ...
				  array(
					...
					"param_name" => "layout",
					"admin_label" => true,
					"value" => array( 'Layout Default' => 'default', 'Layout Theme1' => 'theme1',  'Layout Theme2' => 'theme2',   'Layout Theme3' => 'theme3',  'Layout Featured' => 'featured', 'Layout Top Rated' => 'toprate', 
					 'Layout Best Sales' => 'bestsales',   'Layout Best Sales2' => 'bestsales2', 'Layout Child Category2' => 'childcat2', 'Layout Child Category1' => 'childcat1', 'Layout Daily deals' => 'layout4',  'Layout Daily deals 2' => 'layout6', 'Layout Recommend' => 'layout3',
					 'Layout Recommend 2' => 'layout5', 'Layout Mobile1' => 'theme_mobile', 'Layout Mobile2' => 'theme_mobile2'),
		...
		**/
		function WS_Shortcode( $atts, $content = null ){
			...
			elseif( $layout == 'toprate' ){
				include( sw_override_check( 'sw-slider', 'toprated' ) );			
			}
			elseif( $layout == 'bestsales' ){
				include( sw_override_check( 'sw-slider', 'bestsales' ) );			
			}
			elseif( $layout == 'bestsales2' ){
				include( sw_override_check( 'sw-slider', 'bestsales2' ) );			
			}
			elseif( $layout == 'childcat1' ){
				include( sw_override_check( 'sw-slider', 'childcat1' ) );			
			}
			elseif( $layout == 'childcat2' ){
				include( sw_override_check( 'sw-slider', 'childcat2' ) );			
			}
			elseif( $layout == 'layout3' ){
				include( sw_override_check( 'sw-slider', 'recommend' ) );			
			}
			elseif( $layout == 'layout5' ){
				include( sw_override_check( 'sw-slider', 'recommend2' ) );			
			}
			elseif( $layout == 'layout4' ){
				include( sw_override_check( 'sw-slider', 'dailydeals' ) );			
			}
			elseif( $layout == 'layout6' ){
				include( sw_override_check( 'sw-slider', 'dailydeals2' ) );			
			}
			elseif( $layout == 'theme_mobile' ){
				include( sw_override_check( 'sw-slider', 'theme-mobile' ) );			
			}
			elseif( $layout == 'theme_mobile2' ){
