		...
		<?php 
			...
			<div class="copyright-text">
				<?php if( $topdeal_copyright_text == '' ) : ?>
					<p>&copy;<?php echo date('Y') .' '. esc_html__('WordPress Theme SW Topdeal. All Rights Reserved. Designed by ','topdeal'); ?><a class="mysite" href="<?php echo esc_url( 'http://wpthemego.com/' ); ?>"><?php esc_html_e('WpThemeGo.com','topdeal');?></a>.</p>
				<?php else : ?>
