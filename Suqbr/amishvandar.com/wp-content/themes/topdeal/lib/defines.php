...
function topdeal_Options_Setup(){
	...
	$options[] = array(
			...
			'fields' => array(	
					...
					array(
					   'id' => 'page_404',
					   'type' => 'pages_select',
					   'title' => esc_html__('404 Page Content', 'topdeal'),
					   'sub_desc' => esc_html__('Select page 404 content', 'topdeal'),
					   'std' => ''
					),
			)	
		);
	...
	$options[] = array(
			...
			'fields' => array(		
				...
				array(
					'id' => 'custom_color',
					'title' => esc_html__( 'Enable Custom Color', 'topdeal' ),
					'type' => 'checkbox',
					'sub_desc' => esc_html__( 'Check this field to enable custom color and when you update your theme, custom color will not loose.', 'topdeal' ),
					'desc' => '',
					'std' => '0'
				),
	...
	$options[] = array(
			...
			'fields' => array(				
				...
				array(
					...
					'type' => 'upload',
					'title' => esc_html__('Logo Mobile My Account Page', 'topdeal'),
					'sub_desc' => esc_html__( 'Use the Upload button to upload the new mobile logo in my account page', 'topdeal' ),
				...
				array(
					'id' => 'mobile_addcart',
					'type' => 'checkbox',
					'title' => esc_html__('Enable Add To Cart Button', 'topdeal'),
					'sub_desc' => esc_html__( 'Enable Add To Cart Button on product listing', 'topdeal' ),
					'desc' => '',
						'std' => '0'// 1 = on | 0 = off
				),
				...
				array(
					...
					'type' => 'checkbox',
					'title' => esc_html__('Enable Header Other Pages', 'topdeal'),
					'sub_desc' => esc_html__( 'Enable header in other pages which are different with homepage', 'topdeal' ),
					'desc' => '',
						'std' => '0'// 1 = on | 0 = off
				),
				...
				array(
					'id' => 'mobile_jquery',
					'type' => 'checkbox',
					'title' => esc_html__('Include Jquery Revolution', 'topdeal'),
					'sub_desc' => '',
					'desc' => '',
					'std' => '0'// 1 = on | 0 = off
				),
	...
	$options[] = array(
			...
			'fields' => array(
				...
				array(
					'id' => 'more_menu',
					'type' => 'checkbox',
					'title' => esc_html__('Active More Menu', 'topdeal'),
					'sub_desc' => esc_html__('Active more menu if your primary menu is too long', 'topdeal'),
					'desc' => '',
					'std' => '0'// 1 = on | 0 = off
					),
				...
				array(
					'id' => 'info_typon2',
					'type' => 'info',
					'title' => esc_html__( 'Responsive Menu Config', 'topdeal' ),
					'desc' => '',
				...
				array(
					'id' => 'mobile_menu',
					'type' => 'menu_location_multi_select',
					'title' => esc_html__('Mobile & Responsive Menu Location', 'topdeal'),
					'sub_desc' => esc_html__( 'Select theme location to active mobile menu.', 'topdeal' ),
					'std' => 'primary_menu'
				),
				...
				array(
					...
					'type' => 'text',
					'title' => esc_html__('Mobile Menu Title', 'topdeal'),
					'sub_desc' => esc_html__( 'Change title heading of menu responsive. If there are many menu, each title separated by commas.', 'topdeal' ),
					'std' => ''
				),
			)
		);
	...
	$options[] = array(
		...
		'fields' => array(
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product Categories Config', 'topdeal' ),
				'desc' => '',
				'class' => 'topdeal-opt-info'
				),
			...
			array(
				...
				'type' => 'select',
				'title' => esc_html__('Product Category Listing column Desktop', 'topdeal'),
				'options' => array(
					'2' => '2',
					'3' => '3',
					'4' => '4',
			...
			array(
				...
				'type' => 'select',
				'title' => esc_html__('Product Listing Category column Medium Desktop', 'topdeal'),
				'options' => array(
					'2' => '2',
					'3' => '3',
					'4' => '4',	
			...
			array(
				...
				'type' => 'select',
				'title' => esc_html__('Product Listing Category column Tablet', 'topdeal'),
				'options' => array(
					'2' => '2',
					'3' => '3',
					'4' => '4',	
			...
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product General Config', 'topdeal' ),
				'desc' => '',
				'class' => 'topdeal-opt-info'
				),
			...
			array(
					'id' => 'page_redirect',
					'type' => 'pages_select',
					'title' => esc_html__('Page Login Redirect', 'topdeal'),
					'sub_desc' => esc_html__('Select page to redirect after login', 'topdeal'),
					'std' => ''
				),
			...
			array(
				...
				'title' => esc_html__( 'Enable Countdown', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => esc_html__( 'Turn On/Off Product Countdown on product listing', 'topdeal' ),
				'std' => '1'
				),
			
			array(
				'id' => 'product_soldout',
				'title' => esc_html__( 'Product Sold Out', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => esc_html__( 'Turn On/Off product sold out label', 'topdeal' ),
				'std' => '1'
				),
			...
			array(
				'id' => 'newproduct_time',
				'title' => esc_html__( 'New Product', 'topdeal' ),
				'type' => 'number',
				'sub_desc' => '',
				'desc' => esc_html__( 'Set day for the new product label from the date publish product.', 'topdeal' ),
				'std' => '1'
				),
			...
			array(
				'id' => 'info_typo1',
				'type' => 'info',
				'title' => esc_html( 'Product Single Config', 'topdeal' ),
				'desc' => '',
				'class' => 'topdeal-opt-info'
				),
			...
			array(
				...
				'type' => 'select',
				'title' => esc_html__('Sidebar Product Single Layout', 'topdeal'),
				'options' => array(
					'left'	=> esc_html__( 'Left Sidebar', 'topdeal' ),
					'full' => esc_html__( 'Full Layout', 'topdeal' ),		
					'right' => esc_html__( 'Right Sidebar', 'topdeal' )
				...
				'std' => 'left',
				'sub_desc' => esc_html__( 'Select style sidebar product single', 'topdeal' ),
				),
			
			array(
				'id' => 'product_single_style',
				'type' => 'select',
				'title' => esc_html__('Product Detail Style', 'topdeal'),
				'options' => array(
					'default'	=> esc_html__( 'Default', 'topdeal' ),
					'style1' 	=> esc_html__( 'Full Width', 'topdeal' ),	
					'style2' 	=> esc_html__( 'Full Width With Accordion', 'topdeal' ),	
					'style3' 	=> esc_html__( 'Full Width With Accordion 1', 'topdeal' ),	
				),
				'std' => 'default',
				'sub_desc' => esc_html__( 'Select style for product single', 'topdeal' ),
				),
			
			array(
				'id' => 'product_single_thumbnail',
				'type' => 'select',
				'title' => esc_html__('Product Thumbnail Position', 'topdeal'),
				'options' => array(
					'bottom'	=> esc_html__( 'Bottom', 'topdeal' ),
					'left' 		=> esc_html__( 'Left', 'topdeal' ),	
					'right' 	=> esc_html__( 'Right', 'topdeal' ),	
					'top' 		=> esc_html__( 'Top', 'topdeal' ),					
				),
				'std' => 'bottom',
				'sub_desc' => esc_html__( 'Select style for product single thumbnail', 'topdeal' ),
				),		
			...
			array(
				'id' => 'product_brand',
				'title' => esc_html__( 'Enable Product Brand Image', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => esc_html__( 'Turn On/Off product brand image show on single product.', 'topdeal' ),
				'std' => '1'
				),

			array(
				'id' => 'product_single_countdown',
				'title' => esc_html__( 'Enable Countdown Single', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => esc_html__( 'Turn On/Off Product Countdown on product single', 'topdeal' ),
				'std' => '1'
				),
			
			array(
				'id' => 'product_single_buynow',
				'title' => esc_html__( 'Enable Buy Now Button', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => esc_html__( 'Turn On/Off buy now button on product single and quickview', 'topdeal' ),
				'std' => '1'
			),
			...
			array(
				...
				'title' => esc_html__( 'Enable accordion for widget categories', 'topdeal' ),
				'type' => 'checkbox',
				'sub_desc' => '',
				'desc' => '',
				'std' => '1'
	...
	$options[] = array(
			...
			'fields' => array(
				...
				array(
					'id' => 'info_typo2',
					'type' => 'info',
					'title' => esc_html( 'Custom Typography', 'topdeal' ),
					'desc' => '',
					'class' => 'topdeal-opt-info'
				),
				...
				array(
					'id' => 'custom_font',
					'type' => 'google_webfonts',
					'title' => esc_html__('Custom Font', 'topdeal'),
					'sub_desc' => esc_html__( 'Select custom font for custom class', 'topdeal' ), 
					'std' => ''
				),
				
				array(
					'id' => 'custom_font_class',
					'title' => esc_html__( 'Custom Font Class', 'topdeal' ),
					'type' => 'text',
					'sub_desc' => esc_html__( 'Put custom class to this field. Each class separated by commas.', 'topdeal' ),
					'desc' => '',
					'std' => '',
				),
			)
...
add_filter( 'sw_googlefont_api_key_filter', 'topdeal_custom_google_api_key' );
function topdeal_custom_google_api_key(){
	$webfont = ( topdeal_options()->getCpanelValue( 'google_webfonts_api' ) != '' ) ? topdeal_options()->getCpanelValue( 'google_webfonts_api' ) : 'AIzaSyAL_XMT9t2KuBe2MIcofGl6YF1IFzfB4L4';
	return $webfont;
}
