		...
		<div class="div-logined">
			<ul>
				<li>
					...
					?>
					<a class="user-info" href="<?php echo get_permalink( get_option( 'woocommerce_myaccount_page_id' ) ); ?>"><?php echo sprintf( esc_html__( 'Welcome %s', 'topdeal' ), $user_info->user_nicename ); ?></a> - 
