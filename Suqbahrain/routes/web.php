...
Route::post('benefit/payment/pay-success', 'BenefitsController@payment');
Route::get('/benefit/done', 'BenefitController@done');
Route::get('/benefit/fail', 'BenefitController@fail');
//benefit End
...
Route::get('/send-mail', function(){
    ...
    \Mail::to('minarkhan1995@gmail.com')->send(new \App\Mail\TestMail($details));
    echo "mail send";
});
Route::get('/test/test', 'Test\TestController@index');
