...
<div class="row">
    <div class="col-lg-6">
     ...
     <div class="col-lg-6">
        <div class="panel">
            <div class="panel-heading">
                <h3 class="panel-title text-center">{{__('Benefit Credential')}}</h3>
            </div>
            <div class="panel-body">
                <form class="form-horizontal" action="{{ route('payment_method.update') }}" method="POST">
                    ...
                    @csrf
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BENEFIT_TRANSPORTAL_ID">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Benefit Transportal Id')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BENEFIT_TRANSPORTAL_ID" value="{{  env('BENEFIT_TRANSPORTAL_ID') }}" placeholder="Benefit Transportal id" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BENEFIT_TRANSPORTAL_PASSWORD">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Benefit Transportal Password')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BENEFIT_TRANSPORTAL_PASSWORD" value="{{  env('BENEFIT_TRANSPORTAL_PASSWORD') }}" placeholder="Benefit Transportal Password" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <input type="hidden" name="types[]" value="BENEFIT_TERMINAL_KEY">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Benefit Transportal Password')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <input type="text" class="form-control" name="BENEFIT_TERMINAL_KEY" value="{{  env('BENEFIT_TERMINAL_KEY') }}" placeholder="Benefit Terminal Key" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-lg-3">
                            <label class="control-label">{{__('Benefit Sandbox Mode')}}</label>
                        </div>
                        <div class="col-lg-6">
                            <label class="switch">
                                <input value="1" name="benefit_sandbox" type="checkbox" @if (\App\BusinessSetting::where('type', 'benefit_sandbox')->first()->value == 1)
                                    checked
                                @endif>
                                <span class="slider round"></span>
                            </label>
