...
class topdeal_ResmenuSB{
	function __construct(){
		...
		add_action( 'wp_footer', array( $this, 'topdeal_responsive_menu_footer' ) );
	}
	...
	function topdeal_MenuRes_AdFilter( $args ){
		...
		$menu_location_mobiles = topdeal_options()->getCpanelValue( 'mobile_menu' );
	...
	function topdeal_responsive_menu_footer(){
		$menu_locations = topdeal_options()->getCpanelValue( 'mobile_menu' );
				...
				<div id="ResMenuSB" class="menu-responsive-wrapper">
					...
					<div class="menu-responsive-inner">
						...
						<ul class="nav nav-tabs">
							<?php 
								$menu_titles = explode( ',', topdeal_options()->getCpanelValue( 'mobile_menu_title' ) );
							...
							<?php if( has_nav_menu('primary_menu') ) : ?>
								<li class="<?php echo esc_attr( $class_p ); ?>">
									<a href="#ResPrimary" data-toggle="tab" class="tab-primary"><?php echo esc_html__( 'Menu', 'topdeal' ); ?></a>
								</li>
							<?php endif; ?>
								
							<?php if( has_nav_menu('vertical_menu') ) : ?>
								<li class="<?php echo esc_attr( $class_v ); ?>">
									<a href="#ResVertical" data-toggle="tab" class="tab-vertical"><?php echo esc_html__( 'Categories', 'topdeal' ); ?></a>
								</li>
							<?php endif; ?>
							<?php } ?>
						</ul>
									...
									<?php if( has_nav_menu( $location ) ) : ?>
										<?php 
											wp_nav_menu( array(
												...
												'walker' => new topdeal_ResMenu_Walker()
											) );
										?>
									<?php endif; ?>
								</div>
