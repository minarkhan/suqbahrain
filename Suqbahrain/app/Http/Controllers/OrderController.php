...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
    	...
    	//test Mail****************************************************
        // $data["email"] = "minarkhan1995@gmail.com";
        // $data["title"] = "From MinarKhan.com";
        ...
        // Mail::to('minarkhan1995@gmail.com')->send(new InvoiceEmailManager($array));
        ...
        // dd('Mail sent successfully', $request);
        // end test Mail *************************************************
