...
?>
<div id="product_img_<?php echo esc_attr( $post->ID ); ?>" class="woocommerce-product-gallery woocommerce-product-gallery--with-images images product-images loading" data-vertical="<?php echo ( $topdeal_single_thunbmail == 'left' || $topdeal_single_thunbmail == 'right' ) ? 'true' : 'false'; ?>" data-video="<?php echo ( $topdeal_featured_video != '' ) ?  esc_url( 'https://www.youtube.com/embed/' . $topdeal_featured_video ) : ''; ?>">
	<figure class="woocommerce-product-gallery__wrapper">
	<div class="product-images-container clearfix <?php echo esc_attr( 'thumbnail-' . $topdeal_single_thunbmail ); ?>">
		<?php 
