                ...
                <div class="nano-content">
                    ...
                    <ul id="mainnav-menu" class="list-group">
                     ...
                     @endif
                        ...
                        {{--<!--Start distributor manu-->
                        @if(Auth::user()->user_type == 'admin')
                            <li>
                                <a href="#">
                                    <i class="fa fa-user"></i>
                                    <span class="menu-title">{{__('Distributors')}}</span>
                                    <i class="arrow"></i>
                                </a>
                                ...
                                <ul class="collapse">
                                    <li class="">
                                        <a class="nav-link" href="{{ route('distributor.index') }}">{{__('All Distributors')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
                        <!--End distributor manu-->--}}
                        ...
                        @if(Auth::user()->user_type == 'admin')
                            <li>
                                <a href="#">
                                    <i class="fa fa-user"></i>
                                    <span class="menu-title">{{__('BDO')}}</span>
                                    <i class="arrow"></i>
                                </a>

                                <ul class="collapse">
                                    <li class="">
                                        <a class="nav-link" href="{{ route('bdo.index') }}">{{__('All BDO')}}</a>
                                    </li>
                                </ul>
                            </li>
                        @endif
